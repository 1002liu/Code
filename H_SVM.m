function [ A,B ] = H_SVM( )
%% 样本提取
[ train_input,train_target,test_input,test_target ] = H_SVM_draw( );
%%[ train_input,train_target,test_input,test_target ] = new_data_draw( );
...
sprintf('H_SVM准确个数=%d',rightNumber)
sprintf('H_SVM测试准确率=%0.2f',rightratio)
